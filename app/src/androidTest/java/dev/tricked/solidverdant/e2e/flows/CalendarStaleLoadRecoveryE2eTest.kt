...
class CalendarStaleLoadRecoveryE2eTest {
    ...
    @Test
    fun cachedCalendarEntriesRemainVisibleDuringRefreshFailureAndRecoverOnRetry() {
        ...
        assertTrue("A successful retry must issue a new calendar request", server.callsMatching("GET", "/time-entries").size >= 2)
    }
